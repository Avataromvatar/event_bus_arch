...
//   final StreamController<Topic> _listenerStreamController = StreamController.broadcast();
//   @override
...
//       _nodes[t] = node;
//       _listenerStreamController.add(t);
//     }
...
//       tmp = _nodes[element];
//       if (tmp == null) {
//         tmp = _EventNode(element, null, this, onCancel: _cancelStreamInNode);
//         _nodes[element] = tmp;
//         _listenerStreamController.add(element);
//       }
...
//     var n = _nodes[t];
//     if (n == null) {
//       n = _EventNode(t!, null, this, onCancel: _cancelStreamInNode);
//       _nodes[t] = n;
//       _listenerStreamController.add(t);
//     }
...
//   @override
//   // TODO: implement newListener
//   Stream<Topic> get newListener => _listenerStreamController.stream;
// }
